...
public class ImageFile implements Serializable {
    ...
    public void rename(String newName) throws Exception {
        if (newName.contains("@")) {
            ...
            Exception e = new InvalidNameException("Name contains an '@' symbol.");
            Main.logger.log(Level.SEVERE,"Name inappropriately contains '@' symbol.", e);
            throw e;
            ...
            Exception e = new InvalidNameException("Cannot rename to the same name.");
            Main.logger.log(Level.SEVERE,"Name is the same as old name.", e);
            throw e;
    ...
    public void revertName(int entryNumber) {
        ...
        log.addEntry(
                new Entry("Reverted " + getName() + " to prior tags: " + nameWithTags(), nameWithTags()));
    }
